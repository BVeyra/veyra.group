...
const s = StyleSheet.create({
  page: { padding: 38, paddingBottom: 46, fontFamily: "Helvetica", color: colors.text }, header: { flexDirection: "row", justifyContent: "space-between", marginBottom: 10 }, brand: { fontSize: 15, fontWeight: "bold", color: colors.ink }, meta: { fontSize: 8, color: colors.muted, letterSpacing: 1.2 }, rule: { height: 1.5, backgroundColor: colors.brand, marginBottom: 14 }, heading: { fontSize: 19, fontWeight: "bold", color: colors.ink, marginBottom: 8 }, sub: { fontSize: 9.5, color: colors.muted, lineHeight: 1.55, marginBottom: 18 }, section: { marginBottom: 12 }, label: { fontSize: 7.5, color: colors.brand, fontWeight: "bold", letterSpacing: 1.3, marginBottom: 7 }, sectionTitle: { fontSize: 13, fontWeight: "bold", color: colors.ink, marginBottom: 6 }, body: { fontSize: 10, lineHeight: 1.55 }, card: { borderWidth: 1, borderColor: colors.border, borderRadius: 7, padding: 11, marginBottom: 7 }, row: { flexDirection: "row", justifyContent: "space-between", borderBottomWidth: 1, borderBottomColor: colors.border, paddingVertical: 4.5 }, rowLabel: { fontSize: 9, color: colors.muted }, rowValue: { fontSize: 9, fontWeight: "bold", color: colors.ink }, bullet: { flexDirection: "row", gap: 7, marginTop: 6 }, dot: { width: 4, height: 4, marginTop: 5, borderRadius: 2, backgroundColor: colors.brand }, bulletText: { flex: 1, fontSize: 9.5, lineHeight: 1.5 }, cta: { borderWidth: 1, borderColor: colors.brand, borderRadius: 8, padding: 13, marginTop: 4, alignItems: "center" }, ctaTitle: { fontSize: 13, fontWeight: "bold", color: colors.ink, marginBottom: 6 }, ctaBody: { fontSize: 9.5, color: colors.muted, textAlign: "center", lineHeight: 1.5, marginBottom: 10 }, ctaButton: { backgroundColor: colors.brand, color: "#fff", borderRadius: 999, paddingVertical: 8, paddingHorizontal: 20, fontSize: 10, fontWeight: "bold", textDecoration: "none" }, footer: { position: "absolute", bottom: 24, left: 46, right: 46, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: 8, fontSize: 8, color: colors.muted, flexDirection: "row", justifyContent: "space-between" },
});
