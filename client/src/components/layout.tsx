          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            <div className="text-center md:text-left">
              <img
                ...
                draggable={false}
              />
              <p className="text-[#7F8A95] text-sm mb-4">Built for property managers who hate busywork.</p>
            </div>
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex flex-col gap-2">
                <a href="mailto:bruno@veyragroup.ai" className="text-[#7F8A95] hover:text-[var(--emerald)] text-sm font-medium transition-colors">
                  bruno@veyragroup.ai
                </a>
