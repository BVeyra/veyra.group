    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Most operators are stuck today with manual, late, untrusted KPI tracking. The fastest way to get from there to a live, automated, decision-driving dashboard is a workflow audit. The audit identifies which data sources you have, which KPIs are most underserved by the current process, and what the realistic first 30 days of automation should focus on. [Run the free PM Operations Audit](/audit) if the manual spreadsheet has stopped working and you want a concrete plan for replacing it.",
        ],
      },
    ],
    faqs: [
