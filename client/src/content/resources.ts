    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "For independent managers who are ready to build these systems but want to understand where their specific operation has the most room to improve, a workflow audit is the right starting point. It maps your current processes, identifies the gaps that are driving turnover, and prioritizes the changes that will have the biggest impact. You can request one through our free workflow audit (/audit). It takes 30 minutes and gives you a concrete action plan rather than a generic software pitch.",
