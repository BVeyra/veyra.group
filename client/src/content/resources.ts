    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "For operators who want a preliminary view of where response-time friction may be concentrated, the [Free PMS Operations Snapshot](/audit) is a useful first step. It uses self-reported inputs to identify a starting point. A paid Audit is the right next step when the team needs evidence from its actual work-order data.",
        ],
      },
    ],
    faqs: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If you are not sure how much after-hours work is mechanical coordination versus real judgment work, start by documenting the handoffs. The [Free PMS Operations Snapshot](/audit) can help identify a starting point from self-reported inputs. A paid Audit is appropriate before changing an emergency workflow.",
        ],
      },
    ],
    faqs: [
